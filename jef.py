...
CONFIG = {
    ...
    "PRO_MIN_CONFIDENCE": 5.00,
    "PRO_MIN_RR_TP1": 0.70,
    "PRO_MAX_PRE_SIGNAL_MOVE_PCT": 3.00,
    "PRO_MIN_BACKTEST_WR": 40.0,
...
def pro_signal_quality_gate(signal: dict) -> Tuple[bool, str, dict]:
    ...
    try:
        ...
        if conf < float(CONFIG.get("PRO_MIN_CONFIDENCE", 5.0)):
            return False, f"pro_confidence<{CONFIG.get('PRO_MIN_CONFIDENCE', 5.0):.2f}", diagnostics
        ...
        if pf30 < 0.85 or exp30 < 0:
            ...
            if conf < float(CONFIG.get("PRO_MIN_CONFIDENCE", 5.0)):
                return False, "negative_edge_requires_min_confidence", diagnostics
        else:
