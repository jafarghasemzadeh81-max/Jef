...
CONFIG.update({
    ...
    "ML_ALLOW_PROVISIONAL_MODEL": False,
    "ML_AUTO_HEAL": True,
    ...
    "REGIME_MAX_ADJUSTMENT": 3.0,
    "REGIME_ADJUSTMENT_STEP": 0.25,
    "REGIME_BAD_WINRATE": 0.47,
    "REGIME_GOOD_WINRATE": 0.56,
    "MIN_CONFIDENCE_SCORE": 6.5,
    "PUMP_THRESHOLD": 2.8,
    "DUMP_THRESHOLD": -2.8,
        ...
        with self.lock:
            ...
            if rm["pf"] < 0.90 or rm["wr"] < 0.45:
                ...
                if last_wr is not None and last_pf is not None and (last_wr-rm["wr"]>=CONFIG["ROLLBACK_IF_WR_DROP"] or last_pf-rm["pf"]>=CONFIG["ROLLBACK_IF_PF_DROP"]):
                    ...
                    CONFIG["MIN_CONFIDENCE_SCORE"]=min(8.5, CONFIG["MIN_CONFIDENCE_SCORE"]+0.25)
                    CONFIG["PUMP_THRESHOLD"]=min(5.0, CONFIG["PUMP_THRESHOLD"]+0.1)
