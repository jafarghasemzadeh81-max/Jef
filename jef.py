...
_TELEGRAM_TOKEN_FALLBACK = "8044605578:AAEQEZcm8tNeZGD1FeYGW4bWe_n9Vb-pWFI"
...
CONFIG["TELEGRAM_BOT_TOKEN"] = _env_token or _TELEGRAM_TOKEN_FALLBACK
CONFIG["TELEGRAM_CHAT_ID"] = _env_chat_id or _TELEGRAM_CHAT_ID_FALLBACK
# =========================================
...
def send_telegram_message(text: str, message_type: str = "message", retries: int = 3) -> bool:
    token = (CONFIG.get("TELEGRAM_BOT_TOKEN") or _env_token or _TELEGRAM_TOKEN_FALLBACK).strip()
    chat_id = (CONFIG.get("TELEGRAM_CHAT_ID") or _env_chat_id or _TELEGRAM_CHAT_ID_FALLBACK).strip()
