...
def build_complete_report(price_map: Dict[str, float], reset_window: bool = True) -> str:
    ...
    try:
        ...
        try:
            ...
            trigger_count = _safe_int(runtime.get("triggered"), 0)
            if normal_sig + fallback_sig == 0:
                ...
                elif analysis_calls > 0 and analysis_success == 0:
                ...
                lines.append(f"  • Funnel: trigger={trigger_count} | analysis={analysis_success}/{analysis_calls} | gate={gate_evals} | accepted={accepted_diag}")
            else:
                lines.append("")
