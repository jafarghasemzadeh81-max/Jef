...
CONFIG = {
    ...
    "REPORT_VERSION": "21.0-BALANCED",
    "PRO_MIN_CONFIDENCE": 5.7,
    "PRO_MIN_RR_TP1": 0.80,
...
def enhanced_analysis(symbol: str, direction_hint: Optional[str] = None, recovery_mode: bool = False) -> Optional[dict]:
    try:
        ...
        # گیت نهایی PRO کمی بالاتر از حد پایه می‌ماند، ولی دیگر 6.2 ثابت نیست.
...
def build_complete_report(price_map: Dict[str, float]) -> str:
    ...
    try:
        ...
        lines = []
        lines.append("=" * 60)
        lines.append("📊 **گزارش جامع ۳۰ دقیقه‌ای - نسخه 21.0 BALANCED**")
...
def main_loop_v18():
    ...
    """
    logger.info("=" * 60)
    logger.info("🧬 **نسخه 21.0 BALANCED - ADAPTIVE QUALITY + RISK CONTROL**")
...
if __name__ == "__main__":
    print("=" * 60)
    print("🧬 **نسخه 21.0 BALANCED - ADAPTIVE QUALITY + RISK CONTROL**")
