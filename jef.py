...
CONFIG = {
    ...
    "REPORT_VERSION": "22.0-LEVEL5-OBSERVABILITY",
...
def _telemetry_integrity_check(repair: bool = True) -> dict:
    ...
    try:
        ...
        if expected["gate_evaluated"] > expected["analysis_success"]:
            result["issues"].append("gate_evaluated>analysis_success")
        ...
        if result["issues"]:
            ...
            if repair:
                with _RUNTIME_LOCK:
                    ...
                    _RUNTIME_STATE["telemetry_repairs"] = _safe_int(
                        _RUNTIME_STATE.get("telemetry_repairs"), 0) + 1
                    _RUNTIME_STATE["telemetry_integrity_failures"] = _safe_int(
                        _RUNTIME_STATE.get("telemetry_integrity_failures"), 0) + 1
...
def build_complete_report(price_map: Dict[str, float], reset_window: bool = True) -> str:
    ...
    try:
        ...
        lines = []
        lines.append("=" * 60)
        lines.append("📊 **گزارش جامع ۳۰ دقیقه‌ای - LEVEL 5 OBSERVABILITY v22.0**")
        ...
        try:
            ...
            lines.append(f"  • مجموع تعمیرات Telemetry: {_safe_int(runtime.get('telemetry_repairs'))}")
        ...
        try:
            ...
            for coin in coins:
                ...
                if summary:
                    ...
                    elif delivery_status not in ("COOLDOWN",):
