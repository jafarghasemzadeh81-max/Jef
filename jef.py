...
def enhanced_analysis(symbol: str, direction_hint: Optional[str] = None) -> Optional[dict]:
    ...
    try:
        ...
        min_confidence = min(CONFIG.get("MAX_EFFECTIVE_CONFIDENCE", 6.7),
                             CONFIG["MIN_CONFIDENCE_SCORE"] + CONFIG.get("REGIME_CONFIDENCE_ADJUSTMENT", {}).get(regime, 0))
        ...
        if idle_min >= starvation_start:
            ...
            min_confidence = max(5.95, min_confidence - recovery)
